...
const Menu = () => {
    ...
    const filterItems = (category) =>{
        const filtered = category === "all" ? menu : menu.filter((item) => 
  ...
  return (
    ...
    <div className='max-w-screen-2xl mx-auto xl:px-24 section-container bg-gradient-to-r from-0% from-[#FAFAFA]  to-[#FCFCFC] to-100%'>
      ...
      <div className='py-48 flex flex-col justify-center items-center gap-8'>
        ...
        <div className='text-center space-y-7 px-4'>
          ...
          <p className='text-xl text-[#4A4A4A] md:w-4/5 mx-auto'>Come with family & feel the joy of mouthwatering food such as Greek Salad Lasagne,
          Butternut Pumpkin, Tokusen Wagyu, Olivas Relienas and more for a moderate cost</p>
    ...
    <div className='section-container'>
        ...
        <div className='flex flex-col md:flex-row flex-wrap md:justify-between items-center
        space-y-3 mb-8'>
            {/* all category btns*/}
        ...
        <div className='grid mt-10 md:grid-cols-3 lg:grid-cols-3 lg:mx-[-20px] xl:grid-cols-3 2xl:grid-cols-4 sm:grid-cols-2 sm:mx-[-20px] grid-cols-1 gap-4'>
            {
    ...
    <div className='flex justify-center my-12'>
        {
            Array.from({length: Math.ceil(filteredItems.length / itemsPerPage)}
                ...
                "bg-green text-white" : "bg-gray-200"}`}>{index + 1}</button>
            ))
        }
    </div>
